...
#ruta="/Users/macbookair/Desktop/practica2/modelo_QG/" #ruta CARO
os.chdir(ruta)
...
for i in range(0,5):
    ...
    plt.contourf(X[i],Y[i],vortF_dim[i],levels=levels_vort,cmap=cm.jet) #defino la escala mas arriba en funcion de lo que de el ploteo con la linea anterior descomentada
    cbar=plt.colorbar()
